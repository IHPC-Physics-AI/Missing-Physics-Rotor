...
from scipy.signal.windows import hann # Import hann from scipy.signal.windows
import io # Import io for file handling
import scipy.integrate as integrate          # SciPy’s cumulative trapezoidal rule
...
# ---------------------------------------------------------------
file_path = '/20250521-520RPM-ringdown-1hour-scope.csv' # Use the provided file path
