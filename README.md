...
- Enforce NN hidden and output layers to have tanh, and multiplied a factor 0.1 to output layer from knowing scale of ground truth driving_force.
...
- Attempted downsizing for experimental data for 1 in 2 and 1 in 4 then performed FFT. All look similar to 1 in 20, 1 in 10 where only theta mode can be seen. But 1 in 2 and 1 in 4 can see traces of x mode. 
